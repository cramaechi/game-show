//Program that simulates a game show problem in which the contestant randomly chooses 1 out of 3 doors
//that may contain $1,000,000 in cash. However,before the contestant's desired door is 
//revealed, one of the two remaining doorsreveals a consolation prize. At this point,the program prompt's
//the contestant (user) whether he or she wants to switch to the remaining door or stick with their original
//choice. The program, then, restarts the game 10,000 times and documents the total of wins when sticking with
//the original choice and switching for the remaining door.
#include <iostream>
#include <cstdlib>
#include <cmath>
#include <ctime>
